function[psi] = Plot_fieldlines(N, M, k, n, plot)
% Function to solve for a and b to find contours of magnetic field described in CPDE's CW1 Q1.
%
% Inputs:
...
%
% Function uses finite difference methods to solve the PDE given in CW1 of Computational parital
% differential equations Spring 2018 (J. Mestel). The forward euler method is applied to time 
...
% independant of theta, the problem is a 1-D parabolic PDE.
%
